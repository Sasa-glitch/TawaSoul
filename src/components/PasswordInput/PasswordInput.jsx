// components/PasswordInput/PasswordInput.jsx
...
export default function PasswordInput({ registration, placeholder = "*******", id }) {
  ...
  return (
    <Input
      ...
      classNames={{
        input: "dark:text-white text-secondary placeholder:text-slate-600 py-2 px-6 placeholder:text-[.6rem] lg:placeholder:text-xs focus:outline-none focus:border-primary",
        inputWrapper: "dark:bg-oud-wood/50 bg-white dark:border-primary/20 border-primary h-auto w-auto ps-0 py-0 focus-within:border-primary focus-within:shadow-[0_0_15px_rgba(20,184,184,0.4)] transition-all focus:outline-none focus:border-primary",
      }}
    />
  );
}